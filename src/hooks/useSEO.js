...
/**
 * Hook de SEO genérico para qualquer página da aplicação.
 * Atualiza title, description, og:*, twitter:*, canonical e robots no <head>.
 * Restaura os valores anteriores ao desmontar (comportamento de SPA).
 */
