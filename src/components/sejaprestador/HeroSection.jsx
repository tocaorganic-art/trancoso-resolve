        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            <Link to={createPageUrl('CadastroTipo')}>
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold text-lg px-8 py-6 shadow-xl shadow-blue-500/25 w-full sm:w-auto">
                Quero ser Parceiro
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </Link>
            <a href="#como-funciona">
              <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 font-medium px-8 py-6 w-full sm:w-auto">
                Como funciona?
              </Button>
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-6 md:gap-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 text-sm">Pagamento seguro</span>
            </div>
            <div className="flex items-center gap-2">
