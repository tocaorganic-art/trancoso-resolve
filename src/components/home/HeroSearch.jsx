  ...
  return (
    <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16 md:py-24 px-4">
      <div className="container mx-auto max-w-3xl text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-cyan-500/20 border border-cyan-400/40 text-cyan-300 text-xs font-semibold px-4 py-1.5 rounded-full mb-6">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4 drop-shadow-lg">
          ...
          <span className="text-cyan-400">em Trancoso?</span>
        </h1>
        ...
        <form onSubmit={handleSearch} className="flex gap-2 w-full max-w-xl mx-auto mb-8">
          ...
          <Button type="submit" className="h-12 px-6 bg-cyan-500 hover:bg-cyan-600 text-white font-bold rounded-xl text-sm whitespace-nowrap">
