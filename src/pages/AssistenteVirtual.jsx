  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="pt-20 pb-32 px-4 md:px-6 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-orange-300 rounded-full opacity-10 blur-3xl"></div>

        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="mb-6 inline-flex items-center gap-2 bg-orange-500/20 border border-orange-400/30 rounded-full px-4 py-2">
            <MessageCircle className="w-4 h-4 text-orange-400" />
            <span className="text-sm font-semibold text-orange-300">Toca TrIA em Ação</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-brand-primary hover:bg-orange-600 text-white rounded-lg px-8"
            ...
            <Link to={createPageUrl('Assistentevirtual')}>
              <Button
                size="lg"
                variant="outline"
                className="border-border text-foreground hover:bg-muted rounded-lg px-8"
              >
      ...
      <section className="py-20 px-4 md:px-6 bg-card">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Três situações do seu dia a dia que o Assistente resolve sozinho</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="bg-card border-border hover:border-orange-500 transition-colors">
              <CardHeader>
                ...
                <CardTitle>Cliente manda mensagem à noite</CardTitle>
              </CardHeader>
            ...
            {/* Cenário 2 */}
            <Card className="bg-card border-border hover:border-orange-400 transition-colors">
              <CardHeader>
                <div className="w-12 h-12 bg-orange-400/20 rounded-lg flex items-center justify-center mb-4">
                  <Smartphone className="w-6 h-6 text-orange-400" />
                </div>
                <CardTitle>Você está em atendimento</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground">
            ...
            {/* Cenário 3 */}
            <Card className="bg-card border-border hover:border-brand-primary transition-colors">
              <CardHeader>
                <div className="w-12 h-12 bg-brand-primary/20 rounded-lg flex items-center justify-center mb-4">
                  <Zap className="w-6 h-6 text-brand-primary" />
                </div>
                <CardTitle>Perguntas repetidas o dia inteiro</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground">
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Resultados práticos que impactam suas vendas</p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {/* Benefício 1 */}
            <div className="flex gap-4 p-6 rounded-lg bg-card border border-border hover:border-orange-500 transition-colors">
              <div className="shrink-0">
                <CheckCircle2 className="w-6 h-6 text-green-400 mt-1" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-foreground mb-2">Nunca mais perca cliente por falta de resposta rápida</h3>
                <p className="text-muted-foreground">O assistente responde 24 horas por dia, mesmo quando você está offline ou dormindo.</p>
              </div>
            </div>

            {/* Benefício 2 */}
            <div className="flex gap-4 p-6 rounded-lg bg-card border border-border hover:border-orange-400 transition-colors">
              <div className="shrink-0">
                <CheckCircle2 className="w-6 h-6 text-green-400 mt-1" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-foreground mb-2">Transforme visitas ao seu perfil em conversas reais</h3>
                <p className="text-muted-foreground">Quem encontra você na Trancoso Resolve pode ser atendido na hora pelo Assistente de IA.</p>
              </div>
            </div>

            {/* Benefício 3 */}
            <div className="flex gap-4 p-6 rounded-lg bg-card border border-border hover:border-orange-300 transition-colors">
              <div className="shrink-0">
                <CheckCircle2 className="w-6 h-6 text-green-400 mt-1" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-foreground mb-2">Menos tempo respondendo perguntas repetidas</h3>
                <p className="text-muted-foreground">Mais tempo para fazer o que você faz de melhor: atender seus clientes com qualidade.</p>
              </div>
            </div>

            {/* Benefício 4 */}
            <div className="flex gap-4 p-6 rounded-lg bg-card border border-border hover:border-brand-primary transition-colors">
              <div className="shrink-0">
                <CheckCircle2 className="w-6 h-6 text-green-400 mt-1" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-foreground mb-2">Atendimento profissional sem custo extra</h3>
                <p className="text-muted-foreground">Você tem um "atendente virtual" sem pagar salário, comissão ou plantão. Incluído no seu perfil.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 md:px-6 bg-card">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Ative, configure e deixe trabalhando para você</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-6 items-start">
              <div className="shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-brand-primary text-white font-bold text-lg">1</div>
              </div>
              <div className="flex-1 pt-1">
                <h3 className="text-xl font-bold text-foreground mb-2">Você ativa o Assistente de IA no seu painel</h3>
                <p className="text-muted-foreground">Clique em um botão e o assistente começa a funcionar. É instantâneo.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-orange-600 text-white font-bold text-lg">2</div>
              </div>
              <div className="flex-1 pt-1">
                <h3 className="text-xl font-bold text-foreground mb-2">O assistente usa informações do seu perfil</h3>
                <p className="text-muted-foreground">Serviços, horários, bairros atendidos, preços e formas de pagamento — tudo que você já cadastrou na Trancoso Resolve.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-brand-primary text-white font-bold text-lg">3</div>
              </div>
              <div className="flex-1 pt-1">
                <h3 className="text-xl font-bold text-foreground mb-2">Ele atende os primeiros contatos dos clientes</h3>
                <p className="text-muted-foreground">Responde dúvidas básicas, coleta dados importantes e organiza os pedidos. Você recebe tudo pronto e só precisa finalizar o atendimento.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Veja exatamente como o Assistente responde em seu nome</p>
          </div>

          <div className="bg-card rounded-lg border border-border p-6 space-y-4">
            {/* Cliente */}
            <div className="flex justify-end">
              <div className="bg-brand-primary text-white rounded-2xl rounded-tr-none px-4 py-3 max-w-xs">
            ...
            <div className="flex justify-start">
              <div className="bg-muted text-foreground rounded-2xl rounded-tl-none px-4 py-3 max-w-xs">
                <p className="text-sm font-semibold text-orange-500 mb-1">Assistente de IA (em seu nome)</p>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            <div className="flex gap-3 p-4 rounded-lg bg-muted border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">Inteligência artificial focada no seu tipo de serviço,</strong> não em respostas genéricas.
              </p>
            </div>
            ...
            <div className="flex gap-3 p-4 rounded-lg bg-muted border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">Trabalha junto com seu perfil,</strong> suas avaliações e suas estatísticas de desempenho.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Tire suas dúvidas sobre o Assistente de IA</p>
          </div>

          <div className="space-y-4">
            {/* FAQ 1 */}
            <details className="group border border-border rounded-lg p-6 cursor-pointer hover:border-orange-500 transition-colors">
      ...
      {/* CTA Final */}
      <section className="py-20 px-4 md:px-6 bg-gradient-to-r from-orange-600 to-orange-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button
            size="lg"
            className="bg-white text-orange-700 hover:bg-orange-50 rounded-lg px-8"
            onClick={handleActivarClick}
          >
            Ativar Assistente de IA no meu perfil
            <ChevronRight className="w-5 h-5 ml-2" />
