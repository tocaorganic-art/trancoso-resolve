...
export default function PreLancamento() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "transparent", color: "#fff", minHeight: "100vh", position: "relative" }}>
      ...
      {/* ── HERO ── */}
      <section style={{ padding: "72px 24px 64px", textAlign: "center", maxWidth: 620, margin: "0 auto", position: "relative", zIndex: 10 }}>

        {/* Emblema com bolinha pulsando */}
        <div style={{
          display: "inline-flex", alignItems: "center", gap: 8,
          background: "rgba(0, 174, 239, 0.15)", border: "1px solid rgba(0, 174, 239, 0.5)",
          borderRadius: 999, padding: "6px 16px 6px 12px",
          fontSize: "0.78rem", fontWeight: 700, color: "#00AEEF",
        ...
        <h1 style={{
          ...
          Seja um dos{" "}
          <em style={{ fontStyle: "italic", color: "#00AEEF" }}>50 fundadores</em>{" "}
          de Trancoso.
        </h1>

        <p style={{
          fontSize: "clamp(1rem, 2.8vw, 1.15rem)",
          color: "rgba(255,255,255,0.85)", lineHeight: 1.7, marginBottom: 36, maxWidth: 520, margin: "0 auto 36px",
        }}>
          Garanta agora e receba <strong style={{ color: "#00AEEF" }}>60 dias grátis</strong> ao pagar a primeira mensalidade. Sua vitrine digital oficial está esperando por você.
        </p>
        ...
        <p style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.55)" }}>
        ...
        <div style={{
          marginTop: 40,
          background: "rgba(255,255,255,0.1)", border: "1px solid rgba(0, 174, 239, 0.4)",
          backdropFilter: "blur(12px)",
          borderRadius: 16, padding: "20px 28px",
          display: "inline-block", textAlign: "center",
          boxShadow: "0 4px 24px rgba(0, 0, 0, 0.2)",
        }}>
          <span style={{ fontSize: "clamp(2.5rem, 8vw, 3.5rem)", fontWeight: 900, color: "#00AEEF", lineHeight: 1 }}>
            {vagas}
          </span>
          <p style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.75)", marginTop: 4, fontWeight: 500 }}>
      ...
      {/* ── BENEFÍCIOS ── */}
      <section style={{ padding: "64px 24px", background: "rgba(10, 30, 60, 0.55)", backdropFilter: "blur(8px)", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <p style={secLabel}>Por que entrar agora</p>
          <h2 style={{ ...secTitle, color: "#fff" }}>Tudo que você precisa para crescer em Trancoso</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 40 }}>
            {BENEFICIOS.map((b) => (
              <div key={b.title} style={{
                display: "flex", gap: 16, alignItems: "flex-start",
                background: "rgba(255,255,255,0.07)", border: "1px solid rgba(0, 174, 239, 0.25)",
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: "0.92rem", color: "#fff", marginBottom: 3 }}>{b.title}</p>
                  <p style={{ fontSize: "0.83rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.6 }}>{b.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ── CARTÃO DE OFERTA ── */}
      <section style={{ padding: "64px 24px", position: "relative", zIndex: 10 }}>
        <div style={{
          maxWidth: 600, margin: "0 auto",
          background: "rgba(255,255,255,0.08)", border: "1.5px solid rgba(0, 174, 239, 0.4)",
          backdropFilter: "blur(16px)",
          borderRadius: 24, padding: "40px 32px", textAlign: "center",
          boxShadow: "0 8px 40px rgba(0, 0, 0, 0.3)",
        }}>
          <span style={{ fontSize: "2rem" }}>🎁</span>
          <h2 style={{ fontSize: "clamp(1.4rem, 4vw, 2rem)", fontWeight: 900, color: "#fff", marginTop: 12, marginBottom: 8, lineHeight: 1.2 }}>
            Pague a 1ª mensalidade<br />
            e ganhe{" "}
            <em style={{ fontStyle: "italic", color: "#00AEEF" }}>60 dias grátis</em>
          </h2>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.88rem", marginBottom: 28, lineHeight: 1.6 }}>
            ...
            {CHECKLIST.map((item) => (
              <div key={item} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{
                   ...
                   background: "rgba(0, 174, 239, 0.2)", border: "1px solid rgba(0, 174, 239, 0.5)",
                   display: "flex", alignItems: "center", justifyContent: "center",
                   fontSize: "0.65rem", color: "#00AEEF", fontWeight: 900, flexShrink: 0,
                 }}>✓</span>
                <span style={{ fontSize: "0.86rem", color: "rgba(255,255,255,0.85)" }}>{item}</span>
              </div>
            ))}
          </div>
          ...
          <p style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.45)", marginTop: 10 }}>
      ...
      <section style={{ padding: "64px 24px", background: "rgba(10, 30, 60, 0.55)", backdropFilter: "blur(8px)", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <h2 style={{ ...secTitle, color: "#fff" }}>Como funciona</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 40 }}>
            {PASSOS.map((p) => (
              <div key={p.num} style={{
                display: "flex", gap: 16, alignItems: "flex-start",
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: "0.92rem", color: "#fff", marginBottom: 2 }}>{p.title}</p>
                  <p style={{ fontSize: "0.83rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.55 }}>{p.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ── CTA FINAL ── */}
      <section style={{ padding: "72px 24px", textAlign: "center", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(1.6rem, 5vw, 2.4rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 12, textShadow: "0 2px 20px rgba(0,0,0,0.4)" }}>
            Não perca sua vaga de fundador.
          </h2>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "0.95rem", marginBottom: 8, lineHeight: 1.6 }}>
            Restam <strong style={{ color: "#00AEEF" }}>{vagas}</strong> vagas com 60 dias grátis.
          </p>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.85rem", marginBottom: 36 }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{
        borderTop: "1px solid rgba(255,255,255,0.1)", padding: "32px 24px",
        background: "rgba(10, 20, 50, 0.7)", backdropFilter: "blur(8px)", textAlign: "center",
